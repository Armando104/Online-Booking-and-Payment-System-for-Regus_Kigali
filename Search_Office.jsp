    ...
    <body style="background-color: black">
        <div style="width: 100%;height: 600px;background-color: #8b1010">
           <div style="width: 100%;height: auto;">
               <jsp:include page="Search_Menus.jsp"/>
            </div>
            <center>
                <div style="background-color: white; width: 90%;height: 580px;border-left: 1px dotted #cccccc;border-right: 1px dotted #cccccc;padding: 20px;overflow-y: scroll">
                    ...
                    ${st.msg}
                    <%
                          String op=request.getParameter("ty");
                        
                        %>
                    <h3 style="color: black">Available <%=" "+op+" "  %> For Renting</h3>
                        ...
                        <tbody>
                            <%
                                ...
                                for (int i = 0; i < ls.size(); i++) {
                                    ...
                                    if(ob==null){
                                        if(ls.get(i).getOfficeType().equalsIgnoreCase(op)){
...
<!--                                <td><%=no%></td>-->
                        ...
                        <button class="btn btn-warning">
                            <a style="color: white" href="View_Office_Images_Search.jsp?xo=<%=ls.get(i).getOfficeId()%>">Take A Look On Them</a>
                        </button>
                                    </td>
                                <%
...
<!--                                <td><%=no%></td>-->
                                ...
                                <td><%=ls.get(i).getCost()+"$"%></td>
                                <td><%=ls.get(i).getOtherDetails()%></td>
                                <td><a href="View_Office_Images_Search.jsp?xo=<%=ls.get(i).getOfficeId()%>"><img src="a.icons/FileSeek.png" width="20 " height="20 " alt="add"/></a></td>
                                <%
                                                   }   
                                              }
                                        }else{
